...
amplitude = st.slider('原始震幅 (m)', min_value=0.005, max_value=0.1, value=0.005, step=0.005, format="%.3f")  # 透過滑桿設定初始震幅
...
amplitude_1 = st.slider('原始震幅 (m)', min_value=0.005, max_value=0.1, value=0.005, step=0.005, key='amplitude_1' ,format="%.3f")   # 初始震幅滑桿
